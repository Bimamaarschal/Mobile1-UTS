...
public class TinyDB {
    ...
    public ArrayList<DomainJual> getListObject(String key){
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<DomainJual> playerList =  new ArrayList<DomainJual>();

        for(String jObjString : objStrings){
            DomainJual player  = gson.fromJson(jObjString,  DomainJual.class);
    ...
    public void putListObject(String key, ArrayList<DomainJual> playerList){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(DomainJual player: playerList){
